    ...
    <div className="Home">
        <div className="home__container">
          ...
          <div className="home__row">
            ...
            <Product
            id="23445930"
            title="Amazon Echo (3rdgenerattion) | Smart speaker with Alexa, Charcoal Fabric"
            price={98.99}
            rating={5}
            image="https://media.very.co.uk/i/very/P6LTG_SQ1_0000000071_CHARCOAL_SLf_?$300x400_retinamobilex2$"
            />
            <Product
            id="3254354345"
